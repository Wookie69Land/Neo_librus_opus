...
from app.api.serializers import LibrarySchema
...
@router.post("", response=LibrarySchema)
async def create_library(request, payload: LibrarySchema):
...
@router.put("/{library_id}", response=LibrarySchema)
async def update_library(request, library_id: int, payload: LibrarySchema):
